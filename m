...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 596FD36C93E
	for <lists+linux-block@lfdr.de>; Tue, 27 Apr 2021 18:21:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236534AbhD0QVi (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Tue, 27 Apr 2021 12:21:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51002 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237387AbhD0QUB (ORCPT
        <rfc822;linux-block@vger.kernel.org>);
        Tue, 27 Apr 2021 12:20:01 -0400
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 38A3DC061760;
        Tue, 27 Apr 2021 09:19:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=bombadil.20210309; h=Content-Transfer-Encoding:
        MIME-Version:References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender
        :Reply-To:Content-Type:Content-ID:Content-Description;
        bh=UNcBQhYguJDxa5F/+g7FuHPvsQmliJZ7TEquBEJCaCE=; b=PLvS8vLwY1RWlMnEFuNhLLyVV3
        ;
Received: from [2001:4bb8:18c:28b2:c772:7205:2aa4:840d] (helo=localhost)
        by bombadil.infradead.org with esmtpsa (Exim 4.94 #2 (Red Hat Linux))
        id 1lbQQX-00Gr66-IZ; Tue, 27 Apr 2021 16:19:10 +0000
...
Date:   Tue, 27 Apr 2021 18:16:16 +0200
Message-Id: <20210427161619.1294399-13-hch@lst.de>
...
index b35700710ef9..c26df1f68e5b 100644
--- a/block/blk-mq.c
+++ b/block/blk-mq.c
...
@@ -3890,25 +3881,8 @@ static int blk_mq_poll_classic(struct request_queue *q, blk_qc_t cookie,
 	return 0;
 }
...
@@ -3916,7 +3890,6 @@ int blk_poll(struct request_queue *q, blk_qc_t cookie, unsigned int flags)
 	}
...
index 38eac0434a52..ea05c4373bb2 100644
--- a/block/blk-mq.h
+++ b/block/blk-mq.h
...
index 6e622c1327ee..90e77401b85f 100644
--- a/drivers/block/brd.c
+++ b/drivers/block/brd.c
@@ -286,7 +286,7 @@ static int brd_do_bvec(struct brd_device *brd, struct page *page,
 	return err;
 }
...
@@ -303,16 +303,14 @@ static blk_qc_t brd_submit_bio(struct bio *bio)
...
index 3f3be9408afa..659bdfec9ccc 100644
--- a/drivers/md/dm.c
+++ b/drivers/md/dm.c
...
index 7daac795db39..e728feae093f 100644
...
index 0a8592f916cc..485ccd173799 100644
...
index 0d0de3433f37..4e2c3a6787e9 100644
...
index 80622701c9e9..f2f84cc2c3af 100644
--- a/fs/block_dev.c
+++ b/fs/block_dev.c
...
+		if (!do_poll || !bio_poll(bio, 0))
 	...
 	__set_current_state(TASK_RUNNING);
@@ -1818,7 +1809,7 @@ const struct file_operations def_blk_fops = {
 	.llseek		= block_llseek,
...
index a520775949a0..c599eef13fc1 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
@@ -8099,7 +8099,7 @@ static struct btrfs_dio_private *btrfs_create_dio_private(struct bio *dio_bio,
 	return dip;
 }
...
@@ -8128,7 +8128,7 @@ static blk_qc_t btrfs_submit_direct(struct inode *inode, struct iomap *iomap,
 		}
...
index f89772c155a6..e1c64ed8eba4 100644
...
index 26c06ade7dcd..bb5ed5cf57b4 100644
...
@@ -902,7 +903,7 @@ static inline void rq_flush_dcache_pages(struct request *rq)
...
@@ -952,7 +953,8 @@ blk_status_t errno_to_blk_status(int errno);
...
+int iocb_bio_iopoll(struct kiocb *kiocb, unsigned int flags);
 ...
 {
@@ -1857,7 +1859,7 @@ static inline void blk_ksm_unregister(struct request_queue *q) { }
...
index 629de23091d2..eb3fe8ed9279 100644
...
index 639b761d26a8..6f94da85163d 100644
