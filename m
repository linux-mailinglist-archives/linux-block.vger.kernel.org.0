Return-Path: <linux-block+bounces-28942-lists+linux-block=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-block@lfdr.de
Delivered-To: lists+linux-block@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id A1A6BC0225D
	for <lists+linux-block@lfdr.de>; Thu, 23 Oct 2025 17:34:46 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 2C99F349727
	for <lists+linux-block@lfdr.de>; Thu, 23 Oct 2025 15:34:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 53CE22EB85B;
	Thu, 23 Oct 2025 15:34:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="fre+xvTT"
X-Original-To: linux-block@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8545C33DEEB
	for <linux-block@vger.kernel.org>; Thu, 23 Oct 2025 15:34:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1761233670; cv=none; b=T+b7zBZ+g4RwTZvQbLTsCgglSsO4qxKaWVf1jhdkLeOstrq06QmnabxZPrskx3XJFk1bF/ZZAEbwW4hipJtO/1C2OwhtNcG7x4WfJY0eX5TeESCesnJICduXm7mHjX2VPD/VyGzrtXQTAXBImKalRucr7p4iT1Wd58hJkMt52jY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1761233670; c=relaxed/simple;
	bh=v99gMkqjS09FR7nYn5ZxU7tAQr2BnJnp68qp2aLTDt4=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=hSFOlKTQQWNGfk64JhZD+ocba96wSBZ3DkqLloL5D39oqtwbAAHVUtsk2z+ceGxK+vW7RCMrLMqUR1WkSO9qRemypn6CIA7yCGXlpzbub+D0jPVCx9A/EZvwvQM+uc4kWm1Jnc3+vH5jAVJMR1f0WSuQKpOyHG0EC1j93CQGgqk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=fre+xvTT; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1761233667;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=uGhf+z3iTKR6haq9c1melZFbMCO0SuzPjYL+6CBkbJM=;
	b=fre+xvTT14sHNfMYCoxHmf6q/fSoihCtVKKHN5wCRFVhesyBGTf0J80BWDpSSkC5cWNsPt
	kwrtKRN1fIG4ygr2DlFlkgGKgXUStjL3CXyJT4Dhs9ryPdt67gMCiXlnDuR68puL5993d9
	CWX7eLe9Ky9VOBZEsMUBjVN2zvhRIaQ=
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-357-D70XnW3EO7qnEAqHZMPGSQ-1; Thu,
 23 Oct 2025 11:34:23 -0400
X-MC-Unique: D70XnW3EO7qnEAqHZMPGSQ-1
X-Mimecast-MFC-AGG-ID: D70XnW3EO7qnEAqHZMPGSQ_1761233662
Received: from mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.17])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 11837180060D;
	Thu, 23 Oct 2025 15:34:22 +0000 (UTC)
Received: from localhost (unknown [10.72.120.30])
	by mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 1C1AF19540EB;
	Thu, 23 Oct 2025 15:34:20 +0000 (UTC)
...
Subject: [PATCH V2 22/25] selftests: ublk: handle UBLK_U_IO_COMMIT_IO_CMDS
Date: Thu, 23 Oct 2025 23:32:27 +0800
Message-ID: <20251023153234.2548062-23-ming.lei@redhat.com>
...
index 2de422cf3f1c..62bee39db52b 100644
...
index 0cecde526a2c..5a90b99495e8 100644
...
@@ -210,6 +218,7 @@ struct ublk_thread {
 	void *commit_buf;
...
+	struct batch_commit_buf commit;
 ...
 struct ublk_dev {
@@ -418,30 +427,6 @@ static inline struct ublk_io *ublk_get_io(struct ublk_queue *q, unsigned tag)
 	return &q->ios[tag];
 }
...
-
 ...
 {
@@ -495,6 +480,42 @@ int ublk_batch_alloc_buf(struct ublk_thread *t);
