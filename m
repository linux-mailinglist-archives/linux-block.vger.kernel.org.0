...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CE5BE3CD165
	for <lists+linux-block@lfdr.de>; Mon, 19 Jul 2021 12:00:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236142AbhGSJRd (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Mon, 19 Jul 2021 05:17:33 -0400
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124]:53469 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S236132AbhGSJRa (ORCPT
        <rfc822;linux-block@vger.kernel.org>);
        Mon, 19 Jul 2021 05:17:30 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1626688690;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=2NT3PaokRuS38uCwmB5nGUDQX52tsdW5PO8sloDtOdw=;
        b=WvqlDLyzF+W3HnJynx/Ot1t2BE+F4Xdx7ZaTr5V893ycHgNNumUQI8qnIuLyWMVNk7kjcw
        ZXl4ARdEQX4F+O7ys1sb1Wb8695QyW6bxbvYib7C/KKmAN61l+PKkIvRIB5bW8fo+HqLu9
        /l2npYWIo+jG6VT8zd7sdDfCEkQTTtw=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-328-WavCbzTwOseTvOF_n9xMiw-1; Mon, 19 Jul 2021 05:58:08 -0400
X-MC-Unique: WavCbzTwOseTvOF_n9xMiw-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 901F4800050;
        Mon, 19 Jul 2021 09:58:07 +0000 (UTC)
Received: from localhost (ovpn-12-118.pek2.redhat.com [10.72.12.118])
        by smtp.corp.redhat.com (Postfix) with ESMTP id ED4FB10016F2;
        Mon, 19 Jul 2021 09:58:02 +0000 (UTC)
From:   Ming Lei <ming.lei@redhat.com>
To:     Thomas Gleixner <tglx@linutronix.de>, Jens Axboe <axboe@kernel.dk>
Cc:     linux-kernel@vger.kernel.org, linux-block@vger.kernel.org,
        Christoph Hellwig <hch@lst.de>, Ming Lei <ming.lei@redhat.com>
Subject: [RFC PATCH 4/7] genirq/affinity: rename irq_build_affinity_masks as group_cpus_evenly
Date:   Mon, 19 Jul 2021 17:57:26 +0800
Message-Id: <20210719095729.834332-5-ming.lei@redhat.com>
...
the API for blk-mq to implement default queue mapping.
...
index 98343a6c0aff..073200964110 100644
...
@@ -473,7 +474,7 @@ irq_create_affinity_masks(unsigned int nvecs, struct irq_affinity *affd)
