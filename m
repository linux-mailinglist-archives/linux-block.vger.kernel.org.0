Return-Path: <linux-block+bounces-5359-lists+linux-block=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-block@lfdr.de
Delivered-To: lists+linux-block@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 66B37890B20
	for <lists+linux-block@lfdr.de>; Thu, 28 Mar 2024 21:21:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A87B81F2826D
	for <lists+linux-block@lfdr.de>; Thu, 28 Mar 2024 20:21:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A6C4E13E6B9;
	Thu, 28 Mar 2024 20:17:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.microsoft.com header.i=@linux.microsoft.com header.b="CVfwQNqF"
X-Original-To: linux-block@vger.kernel.org
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2765913B5A3;
	Thu, 28 Mar 2024 20:17:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=13.77.154.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711657061; cv=none; b=anjk85OUy3K0zE3C6Pxw1fldtBdZAWuvEOCnZyqgFKs4/WEvinSksnqjJdHeiHVG3oPtonT3cMZ6Y888sZ6M+FCp0LOlmW81BO+1UUut6Z6ToM+0eRZlBjXbsGNKb7llZb5PR8u0Wejlpxry/DqSsAl7QAI/kZR9ZV1MuGRTxyU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711657061; c=relaxed/simple;
	bh=Z2b/Z6lQajkdYhzhPqqMh1d55Kbd0TpHxqtZb8uCSj8=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References; b=gYono6s4p+MMIPnnuwRLdpy2Nm44Q4oMPIP0u/lWKnZ5LeQGIxaOHqUF/EkVZ+YlhSUUtfHgnJXJwHZ86ejT/8rnS9y1r/xfIEg27OPE7TT6r2WNUkheJq3r4KE4xeZkuZCMtWJk17gRncUwnjQtjo18JrQV7IfNgx9oPbEVdlo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.microsoft.com; spf=pass smtp.mailfrom=linux.microsoft.com; dkim=pass (1024-bit key) header.d=linux.microsoft.com header.i=@linux.microsoft.com header.b=CVfwQNqF; arc=none smtp.client-ip=13.77.154.182
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.microsoft.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linux.microsoft.com
Received: by linux.microsoft.com (Postfix, from userid 1052)
	id 8DF0620E6F08; Thu, 28 Mar 2024 13:17:28 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 8DF0620E6F08
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
	s=default; t=1711657049;
	bh=BEZkPWWuE7ZjbEwuDKtmftIPv6CdyHHjJTfyGj3Pz50=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=CVfwQNqFXLIB8jW7jmT1xSG9idYhxJS+kdv2s+iZaLBmAmLk5UClBkgZ4+o/eUdPk
	 /PEsG+q6BfgaKT38/rdgdbObK5MzPsX1/9EljcMmxOaWXLbZ9b/p+AL2q8ffq5e60a
	 RNwnC4XJx7I6/kOS3ZMjJr97eROCEhiJAR6yNRrc=
...
Subject: [PATCH v16 20/20] documentation: add ipe documentation
Date: Thu, 28 Mar 2024 13:17:27 -0700
Message-Id: <1711657047-10526-21-git-send-email-wufan@linux.microsoft.com>
...
index 000000000000..ba9cea4b6872
--- /dev/null
...
index bb884c14b2f6..52196f4625f7 100644
...
index e13cf10211c8..431725066d81 100644
--- a/Documentation/filesystems/fsverity.rst
+++ b/Documentation/filesystems/fsverity.rst
@@ -97,7 +97,8 @@ authenticating fs-verity file hashes include:
...
+  understanding its operational modes, please refer to
+  Documentation/admin-guide/LSM/ipe.rst.
 
 - Trusted userspace code in combination with `Built-in signature
   verification`_.  This approach should be used only with great care.
@@ -512,6 +513,7 @@ be carefully considered before using them:
...
index f4c66ef54ef9..e235345dcc45 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -10749,6 +10749,8 @@ M:	Fan Wu <wufan@linux.microsoft.com>
