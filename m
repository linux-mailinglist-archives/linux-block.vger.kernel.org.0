...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7D12C26826E
	for <lists+linux-block@lfdr.de>; Mon, 14 Sep 2020 04:09:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725981AbgINCJB (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Sun, 13 Sep 2020 22:09:01 -0400
Received: from us-smtp-delivery-124.mimecast.com ([216.205.24.124]:41524 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725973AbgINCJA (ORCPT
        <rfc822;linux-block@vger.kernel.org>);
        Sun, 13 Sep 2020 22:09:00 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1600049338;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=cFpR+ip6uG8oKSm0d7bWdaLg/gIK+NXLpNYraI19JU0=;
        b=ZbgD5pikiVY59cCVILGdFqRZsU+U7uZzf4rnLguZNCvjnMB5bhv/jcfOK/VVPfnt1p/vZZ
        kcm7JBpxrqmjI4C5Ig+/lc+niVoedQye21ZoiRsXTh6LUvGKTGLZ6WUNtvPwlzAvpd5ih0
        FSRnif/CwgHYZkoIhreHn2EKoeQyBQ0=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-131-6JwpiXOUNJOPRy4yZ4q1sA-1; Sun, 13 Sep 2020 22:08:54 -0400
X-MC-Unique: 6JwpiXOUNJOPRy4yZ4q1sA-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.11])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 9C5381DDEF;
        Mon, 14 Sep 2020 02:08:52 +0000 (UTC)
Received: from localhost (ovpn-12-38.pek2.redhat.com [10.72.12.38])
        by smtp.corp.redhat.com (Postfix) with ESMTP id C9E107B7AF;
        Mon, 14 Sep 2020 02:08:48 +0000 (UTC)
...
Subject: [PATCH V6 2/4] blk-mq: implement queue quiesce via percpu_ref for BLK_MQ_F_BLOCKING
Date:   Mon, 14 Sep 2020 10:08:25 +0800
Message-Id: <20200914020827.337615-3-ming.lei@redhat.com>
...
index c7d424e76781..65b39a498479 100644
--- a/block/blk-mq.c
+++ b/block/blk-mq.c
...
@@ -2004,7 +2008,7 @@ static blk_status_t __blk_mq_try_issue_directly(struct blk_mq_hw_ctx *hctx,
 	bool run_queue = true;
...
@@ -2052,11 +2056,14 @@ static void blk_mq_try_issue_directly(struct blk_mq_hw_ctx *hctx,
...
@@ -2064,19 +2071,22 @@ static void blk_mq_try_issue_directly(struct blk_mq_hw_ctx *hctx,
...
@@ -2607,20 +2617,6 @@ static void blk_mq_exit_hw_queues(struct request_queue *q,
 	}
 }
...
@@ -2658,7 +2654,7 @@ blk_mq_alloc_hctx(struct request_queue *q, struct blk_mq_tag_set *set,
 	struct blk_mq_hw_ctx *hctx;
...
@@ -2701,8 +2697,6 @@ blk_mq_alloc_hctx(struct request_queue *q, struct blk_mq_tag_set *set,
 	if (!hctx->fq)
 		goto free_bitmap;
...
-		init_srcu_struct(hctx->srcu);
 	...
 	return hctx;
@@ -3182,6 +3176,13 @@ static void blk_mq_realloc_hw_ctxs(struct blk_mq_tag_set *set,
...
+
 struct request_queue *blk_mq_init_allocated_queue(struct blk_mq_tag_set *set,
 						  ...
 						  bool elevator_init)
@@ -3198,6 +3199,14 @@ struct request_queue *blk_mq_init_allocated_queue(struct blk_mq_tag_set *set,
...
@@ -3206,7 +3215,7 @@ struct request_queue *blk_mq_init_allocated_queue(struct blk_mq_tag_set *set,
...
@@ -3240,6 +3249,9 @@ struct request_queue *blk_mq_init_allocated_queue(struct blk_mq_tag_set *set,
...
index 81722cdcf0cb..c3868bd10255 100644
--- a/block/blk-sysfs.c
+++ b/block/blk-sysfs.c
@@ -795,9 +795,13 @@ static void blk_release_queue(struct kobject *kobj)
...
index 5bd96fbab9b4..cd9b040232c1 100644
