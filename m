Return-Path: <linux-block+bounces-343-lists+linux-block=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-block@lfdr.de
Delivered-To: lists+linux-block@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id E92977F2D1C
	for <lists+linux-block@lfdr.de>; Tue, 21 Nov 2023 13:27:37 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 97FCA28297D
	for <lists+linux-block@lfdr.de>; Tue, 21 Nov 2023 12:27:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1E04D4A99B;
	Tue, 21 Nov 2023 12:27:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="YEnG+onw"
X-Original-To: linux-block@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B14FA126
	for <linux-block@vger.kernel.org>; Tue, 21 Nov 2023 04:27:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1700569645; x=1732105645;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=MFF/gIuNN5QzJwxBNvaKasgE/3jFrIc6hWqkfSmx3lo=;
  b=YEnG+onw7vU8e2FVL12cGYyaD5aDO6u9J/PV4eygmVjE0r2QbEgmM5Xe
   I3KcfdCCRjHDL/gXzenSjkQJMUxSoRIvG9m63dkIZRyIt+4IDbRduFOCV
   KmSZuVrDlaj0Z29yOUUR1Ld7fTpXLcef2n3zza1lqx0mbJKvOjriqGB8X
   13TS/36b47Vl5chRl8vCfB5Jlvefi5IDX0ndEos4W3w/Of2N2siFDOat0
   vo/7LglAvpTVVFNyBh2rMNYDT74DfMU/zj2s+IVn/esfUvarSxuuaFspk
   /pr92PgHJmEHMceqAFvsMRIg8u53a6k1Lg+LnqeU+7cyxiyzFNJzir1/l
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10900"; a="5021488"
X-IronPort-AV: E=Sophos;i="6.04,215,1695711600"; 
   d="scan'208";a="5021488"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Nov 2023 04:27:22 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10900"; a="832633458"
X-IronPort-AV: E=Sophos;i="6.04,215,1695711600"; 
   d="scan'208";a="832633458"
...
Received: by box.shutemov.name (Postfix, from userid 1000)
	id 4F63210A38B; Tue, 21 Nov 2023 15:27:17 +0300 (+03)
...
Cc: kirill.shutemov@linux.intel.com,
	...
	mpe@ellerman.id.au,
	snitzer@kernel.org
Subject: [PATCH 2/2] mm, treewide: Rename MAX_ORDER to MAX_PAGE_ORDER
Date: Tue, 21 Nov 2023 15:27:12 +0300
Message-ID: <20231121122712.31339-2-kirill.shutemov@linux.intel.com>
...
Please correct this to standard English:
...
index 120153e44ae0..8c99df2010d9 100644
...
index d3acecc5db4b..f0e215060b75 100644
...
index 1c2829ed8348..51235f63261a 100644
...
@@ -1758,8 +1758,8 @@ static inline bool movable_only_nodes(nodemask_t *nodes)
...
index 89971a894b60..f4576ebce2d0 100644
--- a/mm/Kconfig
+++ b/mm/Kconfig
...
index 1169ef2f2176..bb199876efcd 100644
--- a/mm/hugetlb.c
+++ b/mm/hugetlb.c
@@ -3403,7 +3403,7 @@ static void __init prep_and_add_bootmem_folios(struct hstate *h,
...
+ * Note: This only applies to gigantic (order > MAX_PAGE_ORDER) pages.
 ...
 {
@@ -4783,7 +4783,7 @@ static int __init default_hugepagesz_setup(char *s)
...
index ab41a511e20a..c88d9ebd0f17 100644
...
index 506f8220c5fe..c499e5731151 100644
--- a/mm/vmscan.c
+++ b/mm/vmscan.c
@@ -6365,7 +6365,7 @@ unsigned long try_to_free_pages(struct zonelist *zonelist, int order,
