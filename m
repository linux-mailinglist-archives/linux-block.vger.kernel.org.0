...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EBA3D32152
	for <lists+linux-block@lfdr.de>; Sun,  2 Jun 2019 02:45:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726343AbfFBAp5 (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Sat, 1 Jun 2019 20:45:57 -0400
Received: from mx.ewheeler.net ([66.155.3.69]:33734 "EHLO mx.ewheeler.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726211AbfFBAp5 (ORCPT <rfc822;linux-block@vger.kernel.org>);
        Sat, 1 Jun 2019 20:45:57 -0400
Received: from localhost (localhost [127.0.0.1])
        by mx.ewheeler.net (Postfix) with ESMTP id 0DBDEA0C94;
        Sun,  2 Jun 2019 00:45:56 +0000 (UTC)
X-Virus-Scanned: amavisd-new at ewheeler.net
Received: from mx.ewheeler.net ([127.0.0.1])
        by localhost (mx.ewheeler.net [127.0.0.1]) (amavisd-new, port 10024)
        with LMTP id X86K4I6Sho-4; Sun,  2 Jun 2019 00:45:54 +0000 (UTC)
Received: from mx.ewheeler.net (mx.ewheeler.net [66.155.3.69])
        (using TLSv1 with cipher DHE-RSA-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx.ewheeler.net (Postfix) with ESMTPSA id 85681A0C84;
        Sun,  2 Jun 2019 00:45:54 +0000 (UTC)
Date:   Sun, 2 Jun 2019 00:45:54 +0000 (UTC)
From:   Eric Wheeler <linux-block@lists.ewheeler.net>
X-X-Sender: lists@mx.ewheeler.net
To:     dm-devel@redhat.com
cc:     linux-block@vger.kernel.org
Subject: Re: WARNING: CPU: 0 PID: 29149 at kernel/workqueue.c:2911
 __flush_work.isra.29+0x19f/0x1b0
In-Reply-To: <alpine.LRH.2.11.1906020035270.27699@mx.ewheeler.net>
Message-ID: <alpine.LRH.2.11.1906020041500.27699@mx.ewheeler.net>
References: <alpine.LRH.2.11.1905112314120.31149@mx.ewheeler.net> <alpine.LRH.2.11.1906020035270.27699@mx.ewheeler.net>
...
On Sun, 2 Jun 2019, Eric Wheeler wrote:
...
Could this be an ordering issue here?  

block/blk-core.c:void blk_cleanup_queue(struct request_queue *q)
	/* @q won't process any more request, flush async actions */
	del_timer_sync(&q->backing_dev_info->laptop_mode_wb_timer);
	blk_sync_queue(q);

Should del_timer_sync() be called after blk_sync_queue(), or would that 
