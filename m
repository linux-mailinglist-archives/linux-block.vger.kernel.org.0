...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5F70E7D8ACF
	for <lists+linux-block@lfdr.de>; Thu, 26 Oct 2023 23:45:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344897AbjJZVod (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Thu, 26 Oct 2023 17:44:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41512 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234981AbjJZVoV (ORCPT
        <rfc822;linux-block@vger.kernel.org>);
        Thu, 26 Oct 2023 17:44:21 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 51AE7D57
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=PveRRsk3DU1EzC0tDdCWtFn648wg02u6m2NQaGdEUaM=;
        b=MrR+3J/TQ8OC+ORR5Uj4tuK55G7T9o2Vzok7vJMqtzJZRbB8xJ+70gg/L1BeTVwF9HFhvH
        EH2OWKqbgHUngukzWtt+Ps7bt3xbsoDNy7N04VFoAGcM+KW3wAEl4HfXKx+zvm65sba+i1
        +BEYT1/ZWWO1bPNlUGGCTdvvN+MyG5M=
Received: from mimecast-mx02.redhat.com (mx-ext.redhat.com [66.187.233.73])
 by relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-132-HZAuXY_WOni20RA4YKdS4w-1; Thu,
 26 Oct 2023 17:41:42 -0400
X-MC-Unique: HZAuXY_WOni20RA4YKdS4w-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com [10.11.54.5])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 4D25C1C04B75;
...
Received: from pbitcolo-build-10.permabit.com (pbitcolo-build-10.permabit.lab.eng.bos.redhat.com [10.19.117.76])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 42D5A2949;
        Thu, 26 Oct 2023 21:41:42 +0000 (UTC)
Received: by pbitcolo-build-10.permabit.com (Postfix, from userid 1138)
        id 02FE33003D; Thu, 26 Oct 2023 17:41:41 -0400 (EDT)
From:   Matthew Sakai <msakai@redhat.com>
To:     dm-devel@lists.linux.dev, linux-block@vger.kernel.org
Cc:     Matthew Sakai <msakai@redhat.com>
Subject: [PATCH v4 30/39] dm vdo: implement the block map page cache
Date:   Thu, 26 Oct 2023 17:41:27 -0400
Message-Id: <20231026214136.1067410-31-msakai@redhat.com>
...
---
 drivers/md/dm-vdo/block-map.c | 1231 +++++++++++++++++++++++++++++++++
 drivers/md/dm-vdo/block-map.h |  165 +++++
 2 files changed, 1396 insertions(+)

diff --git a/drivers/md/dm-vdo/block-map.c b/drivers/md/dm-vdo/block-map.c
index a4bf60cd2613..d989e0366a25 100644
...
index 2c4d40f21a69..d13e87b79806 100644
