...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1729D4B6564
	for <lists+linux-block@lfdr.de>; Tue, 15 Feb 2022 09:11:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231377AbiBOILH (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Tue, 15 Feb 2022 03:11:07 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:53302 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235195AbiBOILG (ORCPT
        <rfc822;linux-block@vger.kernel.org>);
        Tue, 15 Feb 2022 03:11:06 -0500
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CE2472DAA7;
        Tue, 15 Feb 2022 00:10:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=bombadil.20210309; h=Content-Transfer-Encoding:
        MIME-Version:Message-Id:Date:Subject:Cc:To:From:Sender:Reply-To:Content-Type:
        Content-ID:Content-Description:In-Reply-To:References;
        bh=T6mt/5/sR+uAFHAX3YaHkbd1TM/U0tPt8HqcDZ+iJjs=; b=NYmxRC/3vJePF9WtcUXFKFOQlm
        ;
Received: from [2001:4bb8:184:543c:6bdf:22f4:7f0a:fe97] (helo=localhost)
        by bombadil.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1nJsvB-001Xza-St; Tue, 15 Feb 2022 08:10:50 +0000
From:   Christoph Hellwig <hch@lst.de>
To:     axboe@kernel.dk
Cc:     corbet@lwn.net, linux-block@vger.kernel.org,
        linux-doc@vger.kernel.org
Subject: [PATCH] block: remove biodoc.rst
Date:   Tue, 15 Feb 2022 09:10:47 +0100
Message-Id: <20220215081047.3693582-1-hch@lst.de>
...
---
 Documentation/block/biodoc.rst | 1155 --------------------------------
 Documentation/block/index.rst  |    1 -
 2 files changed, 1156 deletions(-)
 delete mode 100644 Documentation/block/biodoc.rst

diff --git a/Documentation/block/biodoc.rst b/Documentation/block/biodoc.rst
deleted file mode 100644
index fdebc0fd8468f..0000000000000
...
index 3a41495dd77b5..68f115f2b1c6b 100644
