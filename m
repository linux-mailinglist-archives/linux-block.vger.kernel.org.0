...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9443712BC39
	for <lists+linux-block@lfdr.de>; Sat, 28 Dec 2019 03:13:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726044AbfL1CNc (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Fri, 27 Dec 2019 21:13:32 -0500
Received: from mx.ewheeler.net ([173.205.220.69]:41913 "EHLO mx.ewheeler.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725957AbfL1CNb (ORCPT <rfc822;linux-block@vger.kernel.org>);
        Fri, 27 Dec 2019 21:13:31 -0500
Received: from localhost (localhost [127.0.0.1])
        by mx.ewheeler.net (Postfix) with ESMTP id 5009AA0633;
        Sat, 28 Dec 2019 02:13:30 +0000 (UTC)
X-Virus-Scanned: amavisd-new at ewheeler.net
Received: from mx.ewheeler.net ([127.0.0.1])
        by localhost (mx.ewheeler.net [127.0.0.1]) (amavisd-new, port 10024)
        with LMTP id cpHoKyVG_1Lg; Sat, 28 Dec 2019 02:13:08 +0000 (UTC)
Received: from mx.ewheeler.net (mx.ewheeler.net [173.205.220.69])
        (using TLSv1 with cipher DHE-RSA-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx.ewheeler.net (Postfix) with ESMTPSA id 322D1A0440;
        Sat, 28 Dec 2019 02:13:08 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 mx.ewheeler.net 322D1A0440
Date:   Sat, 28 Dec 2019 02:13:07 +0000 (UTC)
...
In-Reply-To: <alpine.LRH.2.11.1912270137420.26683@mx.ewheeler.net>
Message-ID: <alpine.LRH.2.11.1912271946380.26683@mx.ewheeler.net>
References: <alpine.LRH.2.11.1909251814220.15810@mx.ewheeler.net> <alpine.LRH.2.11.1912201829300.26683@mx.ewheeler.net> <alpine.LRH.2.11.1912270137420.26683@mx.ewheeler.net>
