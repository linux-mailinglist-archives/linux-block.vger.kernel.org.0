Return-Path: <linux-block+bounces-30478-lists+linux-block=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-block@lfdr.de
Delivered-To: lists+linux-block@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id DEC7DC661F7
	for <lists+linux-block@lfdr.de>; Mon, 17 Nov 2025 21:40:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sin.lore.kernel.org (Postfix) with ESMTPS id 179B829716
	for <lists+linux-block@lfdr.de>; Mon, 17 Nov 2025 20:39:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EA64534B199;
	Mon, 17 Nov 2025 20:39:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=meta.com header.i=@meta.com header.b="jdlZFlvI"
X-Original-To: linux-block@vger.kernel.org
Received: from mx0a-00082601.pphosted.com (mx0a-00082601.pphosted.com [67.231.145.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5B7A6285CAA
	for <linux-block@vger.kernel.org>; Mon, 17 Nov 2025 20:39:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=67.231.145.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763411989; cv=none; b=czXlT7zx68AqAJGW7ySLVhnJsiwa4KZ3hoC/padgF5EUBIjPb1XGABZZoX6VBkeJHc3vlawx1t9Kv8pX19CO/WoeY0K8lZX9E4WDmmj7VpNtE9UjaX9V6RCtJCUrc7U4IvhgVjOtB2rhc1ZfqSBp1mjDZTwr5ILjYahHFXg5OCY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763411989; c=relaxed/simple;
	bh=g46FPEowo4pX4IEpPq4sG2K5MJsrLHhhC+o4dNXPKJ4=;
	h=From:To:CC:Subject:Date:Message-ID:MIME-Version:Content-Type; b=oJ32jD1A/aLf3wzi+1UQl7O8nGRmZnSUUIOtoUxOgozcM7SOJaip4QSpIrIH/FA/5tK3qdTKsmPKADns1SDzPHNtybqut5fm7WNUciiWcJi+vDGZFEfZIwje0PIkavtvNNiQsJ+sm9/V2ANRphVDRR0f8XSQZhxtwnD8QWIjHp8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=meta.com; spf=pass smtp.mailfrom=meta.com; dkim=pass (2048-bit key) header.d=meta.com header.i=@meta.com header.b=jdlZFlvI; arc=none smtp.client-ip=67.231.145.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=meta.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=meta.com
Received: from pps.filterd (m0044012.ppops.net [127.0.0.1])
	by mx0a-00082601.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 5AHJ0WR21978199
	for <linux-block@vger.kernel.org>; Mon, 17 Nov 2025 12:39:46 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=meta.com; h=cc
	:content-transfer-encoding:content-type:date:from:message-id
	:mime-version:subject:to; s=s2048-2025-q2; bh=9z742Y4m6Ry8AMunIW
	iG3kWuYnIeC9qMmnvajCKpOKA=; b=jdlZFlvIC6oFtlxOmX7hCeRa0qQ84veSLu
	
Received: from maileast.thefacebook.com ([163.114.135.16])
	by mx0a-00082601.pphosted.com (PPS) with ESMTPS id 4ag3ht4ag4-18
	(version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT)
	for <linux-block@vger.kernel.org>; Mon, 17 Nov 2025 12:39:46 -0800 (PST)
Received: from twshared25002.15.frc2.facebook.com (2620:10d:c0a8:1c::11) by
 mail.thefacebook.com (2620:10d:c0a9:6f::237c) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.2.2562.20; Mon, 17 Nov 2025 20:39:40 +0000
Received: by devbig197.nha3.facebook.com (Postfix, from userid 544533)
	id 87D643E0935B; Mon, 17 Nov 2025 12:39:35 -0800 (PST)
...
Subject: [PATCH] blk-integrity: support arbitrary buffer alignment
Date: Mon, 17 Nov 2025 12:39:35 -0800
Message-ID: <20251117203935.1487303-1-kbusch@meta.com>
...
X-Authority-Analysis: v=2.4 cv=fJ40HJae c=1 sm=1 tr=0 ts=691b8812 cx=c_pps
 a=MfjaFnPeirRr97d5FC5oHw==:117 a=MfjaFnPeirRr97d5FC5oHw==:17
 a=6UeiqGixMTsA:10 a=VkNPw1HP01LnGYTKEx00:22 a=VwQbUJbxAAAA:8 a=yPCof4ZbAAAA:8
 a=xHMqUeLr-KbIvyXNY5YA:9
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjUxMTE3MDE3NSBTYWx0ZWRfXzXNG9bG6Q9LG
 
X-Proofpoint-GUID: wzkHFZZ63GTeh_tfrfVKOaVsrul45EPr
X-Proofpoint-ORIG-GUID: wzkHFZZ63GTeh_tfrfVKOaVsrul45EPr
...
v4->v5:
  ...
  * Fixed up ip checksum when it's split among intervals. The previous
  ...
  the kernel's partial + fold implementation, so I think it's okay now.

  * Fixed up some naming issues that Martin requested from an even
 ...
 4 files changed, 468 insertions(+), 365 deletions(-)

diff --git a/block/blk-settings.c b/block/blk-settings.c
index 51401f08ce05b..cfd084e824af7 100644
...
index 0c4ed97021460..da85458f7a41a 100644
--- a/block/t10-pi.c
+++ b/block/t10-pi.c
@@ -12,462 +12,563 @@
...
index 4da937f96ae2e..7c371bda03806 100644
...
index 2fff8a80dbd25..c21d7674fc24d 100644
