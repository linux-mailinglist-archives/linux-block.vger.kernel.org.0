...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2753B239FC7
	for <lists+linux-block@lfdr.de>; Mon,  3 Aug 2020 08:48:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725926AbgHCGsz (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Mon, 3 Aug 2020 02:48:55 -0400
Received: from mail-wr1-f67.google.com ([209.85.221.67]:39589 "EHLO
        mail-wr1-f67.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725946AbgHCGsz (ORCPT
        <rfc822;linux-block@vger.kernel.org>); Mon, 3 Aug 2020 02:48:55 -0400
Received: by mail-wr1-f67.google.com with SMTP id a5so23121434wrm.6
        for <linux-block@vger.kernel.org>; Sun, 02 Aug 2020 23:48:51 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=ZcZ0neBEzCKJWpqZ9B+EQP7I9t3trNPRTPbcZ5c7y2Y=;
        b=
X-Gm-Message-State: AOAM5317x76T+y7rm4puv+Bh76QN8DYumaMuZwOtNznysWHkRO5DS1Cp
        xnVFGE9EQpf98o+4iXlkeYs=
X-Google-Smtp-Source: ABdhPJw9uzQPb97bpjl5b+7U8J/Cte2MJM35rPW0rBoBLVrI0kWLdb/rxuuyVZcKxrFeSRptLI/Yhg==
X-Received: by 2002:adf:e290:: with SMTP id v16mr13548556wri.259.1596437330836;
        Sun, 02 Aug 2020 23:48:50 -0700 (PDT)
Received: from localhost.localdomain ([2601:647:4802:9070:6dac:e394:c378:553e])
        by smtp.gmail.com with ESMTPSA id z6sm23740647wrs.36.2020.08.02.23.48.48
...
Subject: [PATCH rfc 3/6] nvme: make tests transport type agnostic
Date:   Sun,  2 Aug 2020 23:48:32 -0700
Message-Id: <20200803064835.67927-4-sagi@grimberg.me>
...
---
 ...
 tests/nvme/031 |  4 ++--
 tests/nvme/rc  | 20 +++++++++++++-------
 31 files changed, 91 insertions(+), 85 deletions(-)
...
index 3057b814c508..191f0497416a 100644
--- a/tests/nvme/rc
+++ b/tests/nvme/rc
