...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 20A6A1BBB82
	for <lists+linux-block@lfdr.de>; Tue, 28 Apr 2020 12:46:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726481AbgD1Kq2 (ORCPT <rfc822;lists+linux-block@lfdr.de>);
        Tue, 28 Apr 2020 06:46:28 -0400
Received: from esa2.hgst.iphmx.com ([68.232.143.124]:15241 "EHLO
        esa2.hgst.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726473AbgD1Kq0 (ORCPT
        <rfc822;linux-block@vger.kernel.org>);
        Tue, 28 Apr 2020 06:46:26 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
  t=1588070789; x=1619606789;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=anItOUfl5vmcYutgLjBB9b2+HPYlIT2O1eevM7HtM7g=;
  b=CpsYuABx68OmBYuKmkHV5aj1t4/KQqcewvEwLvys8ehiz/Rs6Uz3BRYi
   8hDFqvzYHOo+pwSrqQNvwo+5jp67yjw4TpvlLEGkjh8U8KgIuueFP1Uzm
   KJsKJnNmsxCldVV1F1BfAUW4tP7rH/oTfCFtX0EluJG5IfoZasZ7nxUWB
   kmFru7KuzNQp6EYkRhuMAY2DBb4Nsb80TIcph3Oi1ID0+1Q0ZiOWqGfL9
   Ez8CmYB4XFq3oZSXrsar4FPYFUaZxBYSoLi9/v/E7on7KzKCn+xEaiFXn
   Vqg7tdsQSRVtDiBRy0/VFt2Pxm4fYdYOR1D9bnKuv4fvnWYAWbcoGPmcK
   A==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.73,327,1583164800"; 
   d="scan'208";a="238886588"
Received: from h199-255-45-15.hgst.com (HELO uls-op-cesaep02.wdc.com) ([199.255.45.15])
  by ob1.hgst.iphmx.com with ESMTP; 28 Apr 2020 18:46:29 +0800
IronPort-SDR: CF/3pPNAa8y2l6IBoJ1Te3bLwrO/y/KNaKtj+e0cC5FhpLR1rxD2IoNMJxEdfjb4JWIavKkcSw
 U3Ww73EWSW3ORsegWbdp44KBNXrwMI2Rs=
Received: from uls-op-cesaip01.wdc.com ([10.248.3.36])
  by uls-op-cesaep02.wdc.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Apr 2020 03:36:32 -0700
IronPort-SDR: Vk62XF+hX6OT8H5acgfizpJutdvsqSTm7Pfaanh+KqFTha2uKc57M+9xFkif5FQp/Sd07PD0bx
 zwtQGX58SHcg==
WDCIronportException: Internal
Received: from unknown (HELO redsun60.ssa.fujisawa.hgst.com) ([10.149.66.36])
  by uls-op-cesaip01.wdc.com with ESMTP; 28 Apr 2020 03:46:23 -0700
...
Subject: [PATCH v9 08/11] scsi: sd_zbc: emulate ZONE_APPEND commands
Date:   Tue, 28 Apr 2020 19:46:02 +0900
Message-Id: <20200428104605.8143-9-johannes.thumshirn@wdc.com>
...
+	u32 max_append;
 	...
 	if (!sd_is_zoned(sdkp))
@@ -421,35 +714,31 @@ int sd_zbc_read_zones(struct scsi_disk *sdkp, unsigned char *buf)
 		goto err;
...
@@ -475,3 +764,28 @@ void sd_zbc_print_zones(struct scsi_disk *sdkp)
 			  sdkp->nr_zones,
 			  sdkp->zone_blocks);
 }
+
