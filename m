Return-Path: <linux-block+bounces-7019-lists+linux-block=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-block@lfdr.de
Delivered-To: lists+linux-block@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B64C8BCCEE
	for <lists+linux-block@lfdr.de>; Mon,  6 May 2024 13:39:51 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id AB3DC1F223C8
	for <lists+linux-block@lfdr.de>; Mon,  6 May 2024 11:39:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7AF87143744;
	Mon,  6 May 2024 11:39:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=dwd.de header.i=@dwd.de header.b="+HMA/b41"
X-Original-To: linux-block@vger.kernel.org
Received: from ofcsgdbm.dwd.de (ofcsgdbm.dwd.de [141.38.3.245])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A65856EB51
	for <linux-block@vger.kernel.org>; Mon,  6 May 2024 11:39:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=141.38.3.245
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714995586; cv=none; b=ZQVsrwuszNDHhdP4cUjI3m9WLsnI0YMRieKLS2YyshHyT+BbkYS7O9/uGZFpuIkwsaTRUQ1TDxfy+r/akzU+1HmYh+n2H6K16bIail7R367r25F+62RpX4Fstsb72NyEokIBrmIC+SgqSSzTmR8GUMbtkDLzOvdPsrC5MdiGpms=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=dwd.de; spf=pass smtp.mailfrom=dwd.de; dkim=pass (2048-bit key) header.d=dwd.de header.i=@dwd.de header.b=+HMA/b41; arc=none smtp.client-ip=141.38.3.245
...
Received: from localhost (localhost [127.0.0.1])
	by ofcsg2dn2.dwd.de (Postfix) with ESMTP id 4VXzky1Kl1z2wlg
	for <linux-block@vger.kernel.org>; Mon,  6 May 2024 11:31:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=dwd.de; h=
	...
	woaceh3s=; b=+HMA/b41BGJPYtcW9DcBDwxbWGhFPu9XEBnmmH+dEp6f1HTvhjZ
	
X-Virus-Scanned: by amavisd-new at csg.dwd.de
Received: from ofcsg2ctev1.dwd.de ([172.30.232.67])
 by localhost (ofcsg2dn2.dwd.de [172.30.232.25]) (amavisd-new, port 10024)
 with ESMTP id dhDaN9H3BQPT for <linux-block@vger.kernel.org>;
 Mon,  6 May 2024 11:31:38 +0000 (UTC)
Received: from ofcsg2ctev1.dwd.de (unknown [127.0.0.1])
	by DDEI (Postfix) with ESMTP id DBA1B5E5FFA
	for <root@ofcsg2dn2.dwd.de>; Mon,  6 May 2024 11:31:37 +0000 (UTC)
Received: from ofcsg2ctev1.dwd.de (unknown [127.0.0.1])
	by DDEI (Postfix) with ESMTP id CD8715E5FF2
	for <root@ofcsg2dn2.dwd.de>; Mon,  6 May 2024 11:31:37 +0000 (UTC)
