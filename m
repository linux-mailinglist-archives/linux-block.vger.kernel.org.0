Return-Path: <linux-block+bounces-5666-lists+linux-block=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-block@lfdr.de
Delivered-To: lists+linux-block@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 94F8E896920
	for <lists+linux-block@lfdr.de>; Wed,  3 Apr 2024 10:43:46 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id AACF81C24733
	for <lists+linux-block@lfdr.de>; Wed,  3 Apr 2024 08:43:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BF1606FE2A;
	Wed,  3 Apr 2024 08:43:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="GiqepYsF"
X-Original-To: linux-block@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7A3655FEE5;
	Wed,  3 Apr 2024 08:43:01 +0000 (UTC)
...
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712133781; c=relaxed/simple;
	bh=Hovi8B9VF3l1hrfidE+9jJTo1G+P4wpId2auREFA+wA=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=OplHxCFgJcBULlOPKYYhGLtarnd+uyS090H+wVlMurGM7HI3C/P0yJ29UYymKheTJk31oNlVFRg+RBnAUFQWzux8fJfmrb7sbMYZTuX4AFTOz7N5u6B3JJ1kPZMMRZLcvyijM29uQ+T8u+i91YSmRMTVJWiXN9cQn36C/Rde0oE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=GiqepYsF; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B602EC433A6;
	Wed,  3 Apr 2024 08:42:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1712133781;
	bh=Hovi8B9VF3l1hrfidE+9jJTo1G+P4wpId2auREFA+wA=;
	h=From:To:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [PATCH v5 07/28] block: Introduce zone write plugging
Date: Wed,  3 Apr 2024 17:42:26 +0900
...
@@ -3006,6 +3028,7 @@ void blk_mq_submit_bio(struct bio *bio)
 	if (ret != BLK_STS_OK) {
 		bio->bi_status = ret;
 		bio_endio(bio);
+		blk_zone_write_complete_request(rq);
...
index 23d9bb21c459..9c9600642299 100644
--- a/block/blk-zoned.c
+++ b/block/blk-zoned.c
@@ -7,6 +7,7 @@
  *
...
@@ -425,12 +488,1009 @@ int blkdev_zone_mgmt_ioctl(struct block_device *bdev, blk_mode_t mode,
 	return ret;
 }
...
@@ -453,6 +1513,9 @@ static int blk_revalidate_zone_cb(struct blk_zone *zone, unsigned int idx,
...
@@ -524,6 +1587,22 @@ static int blk_revalidate_zone_cb(struct blk_zone *zone, unsigned int idx,
 				disk->disk_name);
 			return -ENODEV;
 		}
+
...
+
 	...
 	default:
@@ -560,7 +1639,7 @@ int blk_revalidate_disk_zones(struct gendisk *disk,
 	sector_t capacity = get_capacity(disk);
...
+	int ret = -ENOMEM;
 	...
 	if (WARN_ON_ONCE(!blk_queue_is_zoned(q)))
 		return -EIO;
@@ -593,6 +1672,11 @@ int blk_revalidate_disk_zones(struct gendisk *disk,
 	args.disk = disk;
...
+	}
 	...
 	if (!ret) {
@@ -627,7 +1711,7 @@ int blk_revalidate_disk_zones(struct gendisk *disk,
 		ret = 0;
 	} else {
...
index bca50a9510c8..18778e397e66 100644
--- a/block/blk.h
+++ b/block/blk.h
...
+void blk_zone_write_plug_attempt_merge(struct request *rq);
 static inline void blk_zone_update_request_bio(struct request *rq,
 					       struct bio *bio)
 {
@@ -423,22 +430,56 @@ static inline void blk_zone_update_request_bio(struct request *rq,
...
index 4e81f714cca7..a95b883512ea 100644
...
+bool blk_zone_write_plug_bio(struct bio *bio, unsigned int nr_segs);
 ...
 {
@@ -690,6 +697,11 @@ static inline unsigned int bdev_max_active_zones(struct block_device *bdev)
 {
 	return 0;
 }
