Return-Path: <linux-block+bounces-5780-lists+linux-block=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-block@lfdr.de
Delivered-To: lists+linux-block@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2890D899447
	for <lists+linux-block@lfdr.de>; Fri,  5 Apr 2024 06:43:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3A0B31C26923
	for <lists+linux-block@lfdr.de>; Fri,  5 Apr 2024 04:43:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 528FD262B6;
	Fri,  5 Apr 2024 04:42:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="nR9QFSUj"
X-Original-To: linux-block@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 14FB525774;
	Fri,  5 Apr 2024 04:42:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712292140; cv=none; b=aLQZOIdrCSTIQyu8wU7qMgxKLzsXwiZQQukoeYvkB1285KvKVM2FDQa9Ru7rZRVYu5NQD4W6d4jgLAQWK6SHsKRLxnpvlartH4n/L9x5nbQGbgeMh7R9CxlixiDEJmkE5c3JjPA8Qu3+e/qLDeuAfjqfp3LBXcGFJ5iwmqXsEw4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712292140; c=relaxed/simple;
	bh=kSZMgk9m5/N/8nBM7SEWFuYwE08gjhApMyLX3XzlSiI=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=JUtWNhKGqsDTs5DZSXQMSl/zLc1/yalNbDqmbONTreNAmItVdY+3AQo35A/x9aRErjHjjy9S6MteaiWtJVPsQI4vUgwWcH990MtdOzbTn4hP2GRg3Y7YO0zNgPpZ7nu4WqWUdgnxyq7Olub3Z5aR4nWwxxpCHEzlMgzam7DNqgY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=nR9QFSUj; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B0737C43394;
	Fri,  5 Apr 2024 04:42:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1712292139;
	bh=kSZMgk9m5/N/8nBM7SEWFuYwE08gjhApMyLX3XzlSiI=;
	h=From:To:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [PATCH v6 07/28] block: Introduce zone write plugging
Date: Fri,  5 Apr 2024 13:41:46 +0900
Message-ID: <20240405044207.1123462-8-dlemoal@kernel.org>
...
---
 ...
 block/blk-mq.c            |   32 +-
 block/blk-zoned.c         | 1091 ++++++++++++++++++++++++++++++++++++-
 block/blk.h               |   51 +-
 block/genhd.c             |    3 +-
 include/linux/blk-mq.h    |    2 +
 include/linux/blk_types.h |    8 +-
 include/linux/blkdev.h    |   11 +
 9 files changed, 1201 insertions(+), 11 deletions(-)

diff --git a/block/bio.c b/block/bio.c
index d24420ed1c4c..38baedb39c6f 100644
--- a/block/bio.c
+++ b/block/bio.c
@@ -1576,6 +1576,8 @@ void bio_endio(struct bio *bio)
...
index 3363b1321908..7f8a808b74c1 100644
--- a/block/blk-merge.c
+++ b/block/blk-merge.c
...
index 23d9bb21c459..fefcebd70445 100644
--- a/block/blk-zoned.c
+++ b/block/blk-zoned.c
@@ -7,6 +7,7 @@
  *
...
@@ -32,6 +37,64 @@ static const char *const zone_cond_name[] = {
 };
...
@@ -425,12 +488,1010 @@ int blkdev_zone_mgmt_ioctl(struct block_device *bdev, blk_mode_t mode,
 	return ret;
 }
...
@@ -453,6 +1514,9 @@ static int blk_revalidate_zone_cb(struct blk_zone *zone, unsigned int idx,
...
@@ -524,6 +1588,22 @@ static int blk_revalidate_zone_cb(struct blk_zone *zone, unsigned int idx,
 				disk->disk_name);
 			return -ENODEV;
 		}
+
...
+
 	...
 	default:
@@ -560,7 +1640,7 @@ int blk_revalidate_disk_zones(struct gendisk *disk,
 	sector_t capacity = get_capacity(disk);
...
+	int ret = -ENOMEM;
 	...
 	if (WARN_ON_ONCE(!blk_queue_is_zoned(q)))
 		return -EIO;
@@ -593,6 +1673,11 @@ int blk_revalidate_disk_zones(struct gendisk *disk,
 	args.disk = disk;
...
+	}
 	...
 	if (!ret) {
@@ -627,7 +1712,7 @@ int blk_revalidate_disk_zones(struct gendisk *disk,
 		ret = 0;
 	} else {
...
index bca50a9510c8..4df969f8fa28 100644
--- a/block/blk.h
+++ b/block/blk.h
...
index 4e81f714cca7..348b57ca0425 100644
